...
parameters {
    ...
    // Group-level parameters (commented out below are toy examples)
    ...
    // Subject-parameters (commented out below are toy examples)
...
transformed parameters {
    ...
    // (commented out below are toy examples)
        // vector[N] beta;
    ...
    alpha = alpha_pr * alpha_sd + group_alpha;
    side = side_pr * side_sd + group_side;
    sigma = sigma_pr * sigma_sd + group_sigma;
}
model {

    // Group-level priors (commented out below are toy examples)
    ...
    // Subject-level priors (commented out below are toy examples)
