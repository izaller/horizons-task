...
for f in files:
    ...
    games = [dd for dd in games if dd['phase'] == 'task']
    ...
    ## Assemble dictionary.
    time_elapsed = np.round(JSON[-1]['time_elapsed'] * 1e-3 / 60, 2)
    dd = dict(Subject = subject, Time=time_elapsed)
